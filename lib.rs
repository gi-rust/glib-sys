...
extern {
    ...
    pub fn g_bookmark_file_get_app_info(bookmark: *mut GBookmarkFile, uri: *const gchar, name: *const gchar, exec: *mut *mut gchar, count: *mut guint, stamp: *mut libc::time_t) -> gboolean;
    pub fn g_bookmark_file_get_applications(bookmark: *mut GBookmarkFile, uri: *const gchar, length: *mut gsize) -> *mut *mut gchar;
    pub fn g_bookmark_file_get_description(bookmark: *mut GBookmarkFile, uri: *const gchar) -> *mut gchar;
    pub fn g_bookmark_file_get_groups(bookmark: *mut GBookmarkFile, uri: *const gchar, length: *mut gsize) -> *mut *mut gchar;
    pub fn g_bookmark_file_get_icon(bookmark: *mut GBookmarkFile, uri: *const gchar, href: *mut *mut gchar, mime_type: *mut *mut gchar) -> gboolean;
    ...
    pub fn g_bookmark_file_to_data(bookmark: *mut GBookmarkFile, length: *mut gsize) -> *mut gchar;
    ...
    pub fn g_convert(str: *const gchar, len: gssize, to_codeset: *const gchar, from_codeset: *const gchar, bytes_read: *mut gsize, bytes_written: *mut gsize) -> *mut gchar;
    ...
    pub fn g_file_get_contents(filename: *mut gchar, contents: *mut *mut gchar, length: *mut gsize) -> gboolean;
    pub fn g_file_open_tmp(tmpl: *mut gchar, name_used: *mut *mut gchar) -> gint;
    ...
    pub fn g_filename_from_uri(uri: *const gchar, hostname: *mut *mut gchar) -> *mut gchar;
    pub fn g_filename_from_utf8(utf8string: *const gchar, len: gssize, bytes_read: *mut gsize, bytes_written: *mut gsize) -> *mut gchar;
    pub fn g_filename_to_uri(filename: *const gchar, hostname: *const gchar) -> *mut gchar;
    pub fn g_filename_to_utf8(opsysstring: *const gchar, len: gssize, bytes_read: *mut gsize, bytes_written: *mut gsize) -> *mut gchar;
    ...
    pub fn g_io_channel_read_chars(channel: *mut GIOChannel, buf: *mut gchar, count: gsize, bytes_read: *mut gsize) -> GIOStatus;
    pub fn g_io_channel_read_line(channel: *mut GIOChannel, str_return: *mut *mut gchar, length: *mut gsize, terminator_pos: *mut gsize) -> GIOStatus;
    pub fn g_io_channel_read_line_string(channel: *mut GIOChannel, buffer: *mut GString, terminator_pos: gsize) -> GIOStatus;
    pub fn g_io_channel_read_to_end(channel: *mut GIOChannel, str_return: *mut *mut gchar, length: *mut gsize) -> GIOStatus;
    pub fn g_io_channel_read_unichar(channel: *mut GIOChannel, thechar: *mut gunichar) -> GIOStatus;
    ...
    pub fn g_io_channel_write_chars(channel: *mut GIOChannel, buf: *mut gchar, count: gssize, bytes_written: *mut gsize) -> GIOStatus;
    ...
    pub fn g_key_file_get_boolean_list(key_file: *mut GKeyFile, group_name: *const gchar, key: *const gchar, length: *mut gsize) -> *mut gboolean;
    ...
    pub fn g_key_file_get_double_list(key_file: *mut GKeyFile, group_name: *const gchar, key: *const gchar, length: *mut gsize) -> *mut gdouble;
    ...
    pub fn g_key_file_get_integer_list(key_file: *mut GKeyFile, group_name: *const gchar, key: *const gchar, length: *mut gsize) -> *mut gint;
    pub fn g_key_file_get_keys(key_file: *mut GKeyFile, group_name: *const gchar, length: *mut gsize) -> *mut *mut gchar;
    ...
    pub fn g_key_file_get_locale_string_list(key_file: *mut GKeyFile, group_name: *const gchar, key: *const gchar, locale: *const gchar, length: *mut gsize) -> *mut *mut gchar;
    ...
    pub fn g_key_file_get_string_list(key_file: *mut GKeyFile, group_name: *const gchar, key: *const gchar, length: *mut gsize) -> *mut *mut gchar;
    ...
    pub fn g_key_file_load_from_data_dirs(key_file: *mut GKeyFile, file: *mut gchar, full_path: *mut *mut gchar, flags: GKeyFileFlags) -> gboolean;
    pub fn g_key_file_load_from_dirs(key_file: *mut GKeyFile, file: *mut gchar, search_dirs: *mut *mut gchar, full_path: *mut *mut gchar, flags: GKeyFileFlags) -> gboolean;
    ...
    pub fn g_key_file_to_data(key_file: *mut GKeyFile, length: *mut gsize) -> *mut gchar;
    ...
    pub fn g_locale_from_utf8(utf8string: *const gchar, len: gssize, bytes_read: *mut gsize, bytes_written: *mut gsize) -> *mut gchar;
    pub fn g_locale_to_utf8(opsysstring: *const gchar, len: gssize, bytes_read: *mut gsize, bytes_written: *mut gsize) -> *mut gchar;
    ...
    pub fn g_option_context_parse(context: *mut GOptionContext, argc: *mut gint, argv: *mut *mut *mut gchar) -> gboolean;
    pub fn g_option_context_parse_strv(context: *mut GOptionContext, arguments: *mut *mut *mut gchar) -> gboolean;
    ...
    pub fn g_regex_check_replacement(replacement: *const gchar, has_references: *mut gboolean) -> gboolean;
    ...
    pub fn g_regex_match_all_full(regex: *const GRegex, string: *mut gchar, string_len: gssize, start_position: gint, match_options: GRegexMatchFlags, match_info: *mut *mut GMatchInfo) -> gboolean;
    pub fn g_regex_match_full(regex: *const GRegex, string: *mut gchar, string_len: gssize, start_position: gint, match_options: GRegexMatchFlags, match_info: *mut *mut GMatchInfo) -> gboolean;
    ...
    pub fn g_shell_parse_argv(command_line: *const gchar, argcp: *mut gint, argvp: *mut *mut *mut gchar) -> gboolean;
    ...
    pub fn g_spawn_async(working_directory: *const gchar, argv: *mut *mut gchar, envp: *mut *mut gchar, flags: GSpawnFlags, child_setup: Option<GSpawnChildSetupFunc>, user_data: gpointer, child_pid: *mut GPid) -> gboolean;
    pub fn g_spawn_async_with_pipes(working_directory: *const gchar, argv: *mut *mut gchar, envp: *mut *mut gchar, flags: GSpawnFlags, child_setup: Option<GSpawnChildSetupFunc>, user_data: gpointer, child_pid: *mut GPid, standard_input: *mut gint, standard_output: *mut gint, standard_error: *mut gint) -> gboolean;
    ...
    pub fn g_spawn_command_line_sync(command_line: *const gchar, standard_output: *mut *mut gchar, standard_error: *mut *mut gchar, exit_status: *mut gint) -> gboolean;
    pub fn g_spawn_error_quark() -> GQuark;
    pub fn g_spawn_exit_error_quark() -> GQuark;
    pub fn g_spawn_sync(working_directory: *const gchar, argv: *mut *mut gchar, envp: *mut *mut gchar, flags: GSpawnFlags, child_setup: Option<GSpawnChildSetupFunc>, user_data: gpointer, standard_output: *mut *mut gchar, standard_error: *mut *mut gchar, exit_status: *mut gint) -> gboolean;
